...
T=26.5; % Temperature in degree celsius (Use 23.3 degree for phani and 28 for the Transition data, 26.5 for transition delay)
...
Uinf=7.44; % Change free stream velocity here
X=100; % Set X-location here
step=1.5/1000; % Set height for local velocity calculation
